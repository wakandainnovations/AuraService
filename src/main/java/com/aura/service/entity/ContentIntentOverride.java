...
/**
 * One human correction of a mention's {@code content_intent}. Same append-only overlay design as
 * {@link TopicCategoryOverride} — see its javadoc for why this never writes to the upstream
 * ingestion tables directly.
 */
@Entity
@Table(name = "content_intent_overrides")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class ContentIntentOverride {
