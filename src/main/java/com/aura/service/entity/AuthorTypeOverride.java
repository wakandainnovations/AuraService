...
/**
 * One human correction of a mention's {@code author_type}. Same append-only overlay design as
 * {@link TopicCategoryOverride} — see its javadoc for why this never writes to the upstream
 * ingestion tables directly.
 */
@Entity
@Table(name = "author_type_overrides")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class AuthorTypeOverride {
