 ...
 * (or reuses) a USER node, each MOVIE {@code ManagedEntity} it's linked to is materialized into a MOVIE
 * node via {@link GraphNodeFactory}, and a POSTED_ABOUT edge is always written between them. RETWEETED
 * and WATCHED edges are added when the post's content indicates them — see {@link GraphSyncServiceImpl}
